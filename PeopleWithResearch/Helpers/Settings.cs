...
namespace PeopleWithResearch.Helpers
{
    public static class Settings
    {
        ...
        private const string CountyKey = "County";
        private static readonly string CountyDefault = string.Empty;
        public static string County
        {
            get => Preferences.Get(CountyKey, CountyDefault);
            set => Preferences.Set(County, value);
        }
        ...
        private const string DailyNotIdKey = "daily_notification_id";
        private static readonly int DailyNotIdDefault = 0; 

        public static int DailyNotId
        {
            get => Preferences.Get(DailyNotIdKey, DailyNotIdDefault);
            set => Preferences.Set(DailyNotIdKey, value);
        }

        private const string WeeklyNotIdKey = "weekly_notification_id";
        private static readonly int WeeklyNotIdDefault = 0;

        public static int WeeklyNotId
        {
            get => Preferences.Get(WeeklyNotIdKey, WeeklyNotIdDefault);
            set => Preferences.Set(WeeklyNotIdKey, value);
        }

        private const string notificationtimekey = "notificationtime";
        private static readonly string NotificationTimeDefault = string.Empty;
        public static string NotificationTime
        {
            get => Preferences.Get(notificationtimekey, NotificationTimeDefault);
            set => Preferences.Set(NotificationTime, value);
        }
        ...
        // Device Manufacturer
        public const string DeviceManufacturerKey = "devicemanufacturer";
        private static readonly string DeviceManufacturerDefault = string.Empty;
        public static string DeviceManufacturer
        {
            get => Preferences.Get(DeviceManufacturerKey, DeviceManufacturerDefault);
            set => Preferences.Set(DeviceManufacturerKey, value);
        }

        // Device Model
        public const string DeviceModelKey = "DeviceModel";
        private static readonly string DeviceModelDefault = string.Empty;
        public static string DeviceModel
        {
            get => Preferences.Get(DeviceModelKey, DeviceModelDefault);
            set => Preferences.Set(DeviceModelKey, value);
        }

        // Device Version String
        public const string DeviceVersionStringKey = "deviceversion";
        private static readonly string DeviceVersionStringDefault = string.Empty;
        public static string DeviceVersionString
        {
            get => Preferences.Get(DeviceVersionStringKey, DeviceVersionStringDefault);
            set => Preferences.Set(DeviceVersionStringKey, value);
        }
        ...
        private const string userepidkey = "userepid";
        private static readonly string userepidDefault = string.Empty;
        public static string Userepid
        {
            get => Preferences.Get(userepidkey, userepidDefault);
            set => Preferences.Set(Userepid, value);
        }

        private const string validityconfirmedkey = "validityconfirmed";
        private static readonly string validityconfirmedDefault = string.Empty;
        public static string Validityconfirmed
        {
            get => Preferences.Get(validityconfirmedkey, validityconfirmedDefault);
            set => Preferences.Set(Validityconfirmed, value);
        }

        public static string SignupCodeGrouping
        {
            get => Preferences.Default.Get("sideupcodegrouping", string.Empty);
            set => Preferences.Default.Set("sideupcodegrouping", value);
        }


        public static string HouseholdGrouping
        {
            get => Preferences.Default.Get("householdgrouping", string.Empty);
            set => Preferences.Default.Set("householdgrouping", value);
        }

        public static string PrimaryCardId
        {
            get => Preferences.Default.Get("primarycardid", string.Empty);
            set => Preferences.Default.Set("primarycardid", value);
        }

        public static string Details
        {
            get => Preferences.Default.Get("details", string.Empty);
            set => Preferences.Default.Set("details", value);
        }


        public static bool IsPrimaryUser
        {
            get => Preferences.Default.Get("isprimaryuser", false);
            set => Preferences.Default.Set("isprimaryuser", value);
        }

        public static string PrimaryUserID
        {
            get => Preferences.Default.Get("primaryuserid", string.Empty);
            set => Preferences.Default.Set("primaryuserid", value);
        }
